...
myAddCoreRing $RING_WIDTH $RING_SPACE M2 M3
myAddCoreRing $RING_WIDTH $RING_SPACE M4 M3
...
addStripe \
    ...
    -layer M1 \
	-width 0.56 -spacing 3.04 \
    -set_to_set_distance 7.2 \
	-start 6.72 \
	-stop $STRIP_HEIGHT_END
