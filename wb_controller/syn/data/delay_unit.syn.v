...
module delay_FIFO ( clock, reset, data_in, data_out );
  ...
  DFFTRX1TR dff_chain_0__data_out_reg_1_ ( .D(data_in[1]), .RN(n2), .CK(n4), 
        .Q(internal_wire[1]) );
  DFFTRX1TR dff_chain_0__data_out_reg_2_ ( .D(data_in[2]), .RN(n2), .CK(n4), 
        .Q(internal_wire[2]) );
  DFFTRX1TR dff_chain_0__data_out_reg_3_ ( .D(data_in[3]), .RN(n2), .CK(n4), 
        .Q(internal_wire[3]) );
  DFFTRX1TR dff_chain_0__data_out_reg_4_ ( .D(data_in[4]), .RN(n2), .CK(n4), 
        .Q(internal_wire[4]) );
  DFFTRX1TR dff_chain_0__data_out_reg_5_ ( .D(data_in[5]), .RN(n2), .CK(n4), 
        .Q(internal_wire[5]) );
  DFFTRX1TR dff_chain_0__data_out_reg_6_ ( .D(data_in[6]), .RN(n2), .CK(n4), 
        .Q(internal_wire[6]) );
  DFFTRX1TR dff_chain_2__data_out_reg_3_ ( .D(internal_wire[11]), .RN(n1), 
        .CK(n3), .Q(internal_wire[19]) );
  DFFTRX1TR dff_chain_2__data_out_reg_4_ ( .D(internal_wire[12]), .RN(n1), 
        .CK(n3), .Q(internal_wire[20]) );
  DFFTRX1TR dff_chain_2__data_out_reg_5_ ( .D(internal_wire[13]), .RN(n1), 
        .CK(n3), .Q(internal_wire[21]) );
  DFFTRX1TR dff_chain_2__data_out_reg_6_ ( .D(internal_wire[14]), .RN(n1), 
        .CK(n3), .Q(internal_wire[22]) );
  DFFTRX1TR dff_chain_2__data_out_reg_7_ ( .D(internal_wire[15]), .RN(n1), 
        .CK(n3), .Q(internal_wire[23]) );
  DFFTRX1TR dff_chain_0__data_out_reg_7_ ( .D(data_in[7]), .RN(n1), .CK(n3), 
        .Q(internal_wire[7]) );
