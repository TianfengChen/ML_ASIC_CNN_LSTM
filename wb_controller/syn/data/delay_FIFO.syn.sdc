...
# Created by write_sdc on Mon Mar 27 19:21:48 2023
...
set_input_delay -clock clock  0.1  [get_ports {data_in[7]}]
set_input_delay -clock clock  0.1  [get_ports {data_in[6]}]
set_input_delay -clock clock  0.1  [get_ports {data_in[5]}]
set_input_delay -clock clock  0.1  [get_ports {data_in[4]}]
set_input_delay -clock clock  0.1  [get_ports {data_in[3]}]
...
set_output_delay -clock clock  0.1  [get_ports {data_out[7]}]
set_output_delay -clock clock  0.1  [get_ports {data_out[6]}]
set_output_delay -clock clock  0.1  [get_ports {data_out[5]}]
set_output_delay -clock clock  0.1  [get_ports {data_out[4]}]
set_output_delay -clock clock  0.1  [get_ports {data_out[3]}]
