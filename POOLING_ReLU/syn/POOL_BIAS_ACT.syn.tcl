...
read_file -f sverilog [list "../../sys_defs.svh"  \
			  "../verilog/POOL_BIAS_ACT.v" "../verilog/CMP.v" \
        "../verilog/divider_pipe.v" "../verilog/pool_avg.v" \
        "../verilog/pool_max.v" "../verilog/POOLING_top.v" "../verilog/ReLU.v" "../verilog/adder_tree.v" "../verilog/adder_1bit.v"]
list_designs
