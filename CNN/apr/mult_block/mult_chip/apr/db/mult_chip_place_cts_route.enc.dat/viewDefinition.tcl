...
create_library_set -name typLibs\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/arti_ibm13io_syn_tt.lib\
    ${::IMEX::libVar}/mmmc/reset_driver.lib\
    ${::IMEX::libVar}/mmmc/mult_block.lib\
    ${::IMEX::libVar}/mmmc/SIGN_MEM_tt_1p2v_25c_syn.lib]
...
create_constraint_mode -name typConstraintMode\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/typConstraintMode/typConstraintMode.sdc]
create_analysis_view -name setupAnalysis -constraint_mode typConstraintMode -delay_corner worstDelay -latency_file ${::IMEX::dataVar}/mmmc/views/setupAnalysis/latency.sdc
create_analysis_view -name typAnalysis -constraint_mode typConstraintMode -delay_corner typDelay
create_analysis_view -name holdAnalysis -constraint_mode typConstraintMode -delay_corner bestDelay -latency_file ${::IMEX::dataVar}/mmmc/views/holdAnalysis/latency.sdc
